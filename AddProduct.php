<?php
    ...
    if(isset($_POST["submit"]))
    {
        ...
        if($_FILES["image"]["name"] != ''){
            ...
            $sql_add = "INSERT INTO product VALUES('','".$pro_type."','".$pro_name."','".$pro_detail."','".$pro_price."','".$pro_amount."','".$pro_unit."','".$pro_discount."','".$pro_picture."','".$pro_annotation."')";
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="form-group col-xs-6">
                  ...
                  <input type="text" class="form-control" id="new_pro_name" name="new_pro_name" required>
              </div>
              <div class="form-group col-md-12">
                  <label>รายละเอียดสินค้า</label>
                  <textarea class="form-control" row="3" id="new_pro_detail" name="new_pro_detail"></textarea>
              </div>
              <div class="form-group col-xs-4">
                  <label>ราคาสินค้า/หน่วย (บาท)<font color="red"> *</font></label>
                  <input type="number" class="form-control" id="new_pro_price" name="new_pro_price" required>
              </div>
              <div class="form-group col-xs-4">
                  <label>จำนวน<font color="red"> *</font></label>
                  <input type="number" class="form-control" id="new_pro_amount" name="new_pro_amount" required>
              </div>
              <div class="form-group col-xs-4">
              ...
              <div class="form-group col-xs-4">
                  <label>ส่วนลด (%)</label>
                  <input type="number" class="form-control" id="new_pro_discount" name="new_pro_discount">
              </div>
              <!-- <div class="form-group col-xs-4">
                  <label>ชื่อรูปภาพ</label>
                  <input type="text" class="form-control" id="new_name_pro_picture" name="name_filename">
              </div> -->
              <div class="form-group col-xs-4">
                 <label>รูปภาพ</label>
              ...
              <div class="form-group col-md-12">
                ...
                <textarea class="form-control" row="3" id="new_pro_annotation" name="new_pro_annotation"></textarea>
              </div>
              <div class="form-group col-xs-12">
                <button name="submit" type="submit" class="btn btn-success pull-right" id="submit_add">เพิ่ม <i class="fa fa-plus-circle"></i></button>
              </div>
            </form>
            </div>
          </div>
