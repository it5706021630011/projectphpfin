              ...
              <table id="pro_table" class="table table-bordered table-striped">
                ...
                ?>
                    <tr id="row<?php echo $row['emp_id'];?>">
                        ...
                        <td id="cus_point_val<?php echo $row['cus_id'];?>"><?php echo $row['cus_point'];?></td>
                         ...
                         <div class="modal-content">
                            <div class="modal-header">
                              ...
                              <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label>แต้มสะสม<font color="red"> *</font></label>
                                    <input type="text" class="form-control" id="add_cus_point" required>
                                </div>
                                <div class="form-group">
                     ...
                     <div class="modal-dialog">
                         <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <div class="form-group">
                                  <label>แต้มสะสม<font color="red"> *</font></label>
                                  <input type="text" class="form-control" id="edit_cus_point" required>
                              </div>
                              <div class="form-group">
                                  <label>อีเมล์<font color="red"> *</font></label>
