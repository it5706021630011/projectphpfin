...
<body>
  <div align="center" style="font-size: 16px">
    ...
    <h2 align="center">รายงานสินค้าถึงจุดสั่งซื้อ</h2>
  </div>
  <div align="center">
  ...
  <div align="center">
    <table border="1" width="100%" align="center" style="font-size:16px;">
      ...
      <tbody>
          <?php
               $sql = "SELECT * FROM product JOIN product_type ON product_type.pro_type_id = product.pro_type_id JOIN product_unit ON product_unit.pro_unit_id = product.pro_unit_id order by product.pro_id AND product.pro_amount <= 6";
          ...
          ?>
              <tr>
                  ...
                  <td align="right" width="5%"><?php echo "ควรสั่งซื้อเพิ่ม";?></td>
              <?php
               }
              ?>
      </tbody>
